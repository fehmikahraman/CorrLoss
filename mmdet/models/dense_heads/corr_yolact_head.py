...
from mmdet.core import build_sampler, fast_nms, images_to_levels, multi_apply, bbox_overlaps
...
class CorrYOLACTHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(CorrYOLACTHead, self).__init__(
            num_classes,
            in_channels,
            loss_cls=loss_cls,
            loss_bbox=loss_bbox,
    ...
    def loss(self,
        ...
        if self.use_ohem:
            ...
            losses_cls, losses_bbox, losses_corr = multi_apply(
        ...
        return dict(
            loss_cls=losses_cls, loss_bbox=losses_bbox, loss_corr=losses_corr), sampling_results
    ...
    def loss_single_OHEM(self, cls_score, bbox_pred, anchors, labels,
        ...
        return loss_cls[None], loss_bbox, loss_corr
...
@HEADS.register_module()
class CorrYOLACTSegmHead(BaseModule):
    ...
    def __init__(self,
        ...
        super(CorrYOLACTSegmHead, self).__init__(init_cfg)
...
@HEADS.register_module()
class CorrYOLACTProtonet(BaseModule):
    ...
    def __init__(self,
        ...
        super(CorrYOLACTProtonet, self).__init__(init_cfg)
        self.in_channels = in_channels
