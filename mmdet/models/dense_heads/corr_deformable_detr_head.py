...
from mmdet.core import (bbox_cxcywh_to_xyxy, multi_apply, reduce_mean, bbox_overlaps)
...
class CorrDeformableDETRHead(DETRHead):
    ...
    def __init__(self,
        ...
        super(CorrDeformableDETRHead, self).__init__(
    ...
    def loss(self,
        ...
        if enc_cls_scores is not None:
            ...
            enc_loss_cls, enc_losses_bbox, enc_losses_iou, enc_losses_corr = \
            ...
            loss_dict['enc_loss_corr'] = enc_losses_corr
        ...
        num_dec_layer = 0
        for loss_cls_i, loss_bbox_i, loss_iou_i, loss_corr_i in zip(losses_cls[:-1],
                                                                    losses_bbox[:-1],
                                                                    losses_iou[:-1],
                                                                    losses_corr[:-1]):
    ...
    def loss_single(self,
        ...
        if len(pos_inds) > 1:
            ...
            cls_score_pos = cls_scores[pos_inds, labels_pos]
